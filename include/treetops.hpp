	...
	namespace treetops {
		...
		namespace config {
			...
			public:
				...
				std::string smoothInputFile;
				std::string smoothOutputFile;
				...
				std::string topsInputFile;
				std::string topsSmoothedInputFile;
				std::string topsOutputFile;
				...
				std::string crownsInputFile;

				// The treetops database file.
				std::string crownsTreetopsFile;

				std::string crownsOutputRaster;
				std::string crownsOutputVector;
				...
				void checkSmoothing() const {
					...
					if(smoothInputFile.empty())
						g_argerr("Smoothing: CHM filename must not be empty.");
					if(smoothOutputFile.empty())
